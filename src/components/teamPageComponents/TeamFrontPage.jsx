...
function TeamFrontPage() {
	return (
		<div
			id="frontPage"
			className='bg-black flex items-center justify-center min-w-full text-[#ACB8CB] font-["Roboto"] text-center mt-80 mb-72'
		>
			<div className="title opacity-0 flex flex-col items-center justify-center gap-y-6 min-w-full max-w-full">
				<img
					...
					className="logo"
				/>
				<div className="text-[#6C90C2] lg:text-5xl md:text-4xl sm:text-3xl text-2xl font-bold px-3">
