...
function Card({details}) {
  ...
  return (
    <div className='flex flex-col items-center pb-3 font-["Roboto"] max-w-[19rem] bg-black flex-wrap hover:bg-gray-700/20 hover:scale-[1.05] duration-300 hover:rounded-b-2xl cursor-default'>
