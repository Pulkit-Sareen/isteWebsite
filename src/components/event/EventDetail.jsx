...
const EventDetail = ({ event }) => {
  ...
  if (!event) {
    return <div style={{ width: '70%', padding: '1px' }}>Select an event to see details</div>;
  }

  return (
    <div ref={eventDetailRef} className="event-detail-container">
        ...
        <AnimatePresence>
          {event.subEvents.map((subEvent, index) => (
            ...
            >
              ...
              <img src={subEvent.img1} alt="event photo" className="event-img" />
